...
<table style="width:100%;border-collapse:collapse;border:1px solid black;">
    <thead>
        <tr>
            <th width="20%" style="padding:10px 5px;text-align:center;border:1px solid black">Total</th>
            <th width="20%" style="padding:10px 5px;text-align:center;border:1px solid black">Used</th>
            <th width="20%" style="padding:10px 5px;text-align:center;border:1px solid black">Free</th>
            <th width="20%" style="padding:10px 5px;text-align:center;border:1px solid black;color:green">Expected</th>
            <th width="20%" style="padding:10px 5px;text-align:center;border:1px solid black;color:red">Utilisation</th>
        </tr>
    </thead>
    <tbody>
        <tr>
